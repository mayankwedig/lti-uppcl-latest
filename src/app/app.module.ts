  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: "track-complaint", component: TrackComplaintsComponent },
      {
        ...
        component: TrackServiceRequestComponent
      },
      {
        path: "profile",
      ...
      {
        path: "net-metering",
        component: NetMeteringComponent,
        canActivate: [AuthGuard]
      },
      {
        path: "singup-otp-varification",
        component: SingupOtpVarificationComponent
      },
      {
        path: "view-all-service-request",
        component: ViewAllServiceRequestsComponent,
        canActivate: [AuthGuard]
      },
      {
      ...
      },
      {
        ...
        component: DashboarRedirectComponent,
        canActivate: [AuthGuard]
      },
      {
        path: "complaint-request-details",
        component: ComplaintRequestDetailsComponent
      },
      {
        path: "new-service-connection",
        component: NewServiceConnectionComponent
      },
      ...
      },
      {
        ...
        component: ConsumptionEstimatorComponent,
        canActivate: [AuthGuard]
      },
      {
      ...
      { path: "payment-process", component: PaymentProcessComponent },
      {
        ...
        component: TransectionStatusMessageComponent
      },
      {
        path: "change-expired-password",
        component: ChangePasswordWithoutLoginComponent
      },
      {
        path: "peak-load-management",
        component: PeakLoadManageComponent,
        canActivate: [AuthGuard]
      },
      {
        path: "make-payment",
